...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Camera2Basic.Listeners.CameraCaptureSessionCallback, Camera2Basic", CameraCaptureSessionCallback.class, __md_methods);
	}
	...
	public CameraCaptureSessionCallback ()
	{
		...
		if (getClass () == CameraCaptureSessionCallback.class)
			mono.android.TypeManager.Activate ("Camera2Basic.Listeners.CameraCaptureSessionCallback, Camera2Basic", "", this, new java.lang.Object[] {  });
	}

	public CameraCaptureSessionCallback (md5fae1ebab4d31ff6225cd36e349f728e6.Camera2BasicFragment p0)
	{
		super ();
		if (getClass () == CameraCaptureSessionCallback.class)
			mono.android.TypeManager.Activate ("Camera2Basic.Listeners.CameraCaptureSessionCallback, Camera2Basic", "Camera2Basic.Camera2BasicFragment, Camera2Basic", this, new java.lang.Object[] { p0 });
	}
